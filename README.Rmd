...
# secuTrialR ![travis](https://api.travis-ci.com/SwissClinicalTrialOrganisation/secuTrialR.svg?branch=master) [![codecov](https://codecov.io/gh/SwissClinicalTrialOrganisation/secuTrialR/branch/master/graph)](https://codecov.io/gh/SwissClinicalTrialOrganisation/secuTrialR)
...
Individual tables can be extracted from the `sT_export` object via `tab <- sT_export$tab`, where `tab` is the table of interest.
<!-- accessor function? -->
