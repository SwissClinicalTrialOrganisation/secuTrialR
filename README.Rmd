...
<details><summary>Load a dataset</summary>
...
<details><summary>Variable labels</summary>
...
units(labelled$bmd$age)
```
There is a drawback to the attribute based approach - labels will not be propogated if variables are derived and may be lost if variables are edited.

Currently, `label_secuTrial` should be used prior to `dates_secuTrial` or `factorize_secuTrial` so that labels and units are propogated to factor and date variables.

</details>

<details><summary>Prepare factors</summary>
...
<details><summary>Prepare dates</summary>
