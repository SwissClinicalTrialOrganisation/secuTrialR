...
# raw
ctu05_data$baseline$hiv_date
# processed
ctu05_data$baseline$hiv_date.datetime
...
datetime variables and whether or not you would like to perform data imputation.
...
Let's say you would only like to look at the recruitment plot for Bern.
