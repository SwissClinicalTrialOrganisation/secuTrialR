...
```{r}
bone_mineral_dinsity_loc <- system.file("extdata", "sT_exports", "BMD",
...
export_location_shortnames <- system.file("extdata", "sT_exports", "BMD",
                                         "s_export_CSV-xls_BMD_short_en_utf8.zip",
                                          package = "secuTrialR")

export_location_longnames <- system.file("extdata", "sT_exports", "BMD",
...
The code below shows how to load a secuTrial export. The output of read_secuTrial_raw is a list. 

```{r}

sT_export_shortnames <- read_secuTrial_raw(data_dir = export_location_shortnames)
typeof(sT_export_shortnames)
sT_export_longtnames <- read_secuTrial_raw(data_dir = export_location_longnames)
...
```{r}
secuTrialR:::assess_form_variable_completeness(form = sT_export_longtnames$dem00bmd, 
